        ...
        public function esig_ninja_adminmenu() {
            ...
            if (!function_exists('WP_E_Sig')) {
                ...
                if (empty($GLOBALS['admin_page_hooks']['esign'])) {
                    add_menu_page('E-Signature', 'E-Signature', 'read', "esign", array(&$this, 'ninja_about_page'), plugins_url('assets/images/pen_icon.svg', __FILE__));
                    add_submenu_page("esign", "Ninja E-signature", "Ninja E-signature", 'read', "esign", array(&$this, 'ninja_about_page'));
                }
                else 
                {
        ...
        public function esig_invite_document($old_doc_id, $siner_email, $signer_name, $form_id, $post_id, $signing_logic, $notification_id) {
            ...
            if ($signing_logic == "email") {
                ...
                if (self::is_ninja_three()) {
                     ...
                     self::save_esig_nf_meta($invite_hash, "signed", "no");
